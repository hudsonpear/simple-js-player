  ...
  videos.forEach((video) => {
    ...
    */
    ...
    rightClickMenuDiv.innerHTML = `
      ...
      aboutDiv.innerHTML = `
        <span>Simple JS Player v1.0.2</span>
        <br>
        <span>by: Hudson Pear (pyrus)</span>
        <span><a href="https://github.com/hudsonpear/simple-js-player" target="_blank" class="SJP_link">Github Page</a></span>
        <button class="SJP_closeBtn">
          <svg class="SJP_closeBtnSvg" viewBox="0 -960 960 960">
    ...
    //ABOUT CLOSE BUTTON
    const SJP_closeBtn = theVideoContainer.querySelector(".SJP_closeBtn")
    SJP_closeBtn.addEventListener('click', function(event) {
    ...
    video_container.addEventListener('contextmenu', function(event) {
      ...
      if (disableRightClick == '1' || disableRightClick == 'yes') {
        ...
        if (rightClickMenuStyle == "sjp") {
          ...
          theRightClickMenu.style.left = `${event.clientX}px`;
          theRightClickMenu.style.top = `${event.clientY}px`;
        }
